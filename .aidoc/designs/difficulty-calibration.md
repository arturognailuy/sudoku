...
The published evidence remains a measurement baseline, not calibration policy. Imported and pathological strata remain small, the external corpus comes from one source family, and generated target-hit intervals remain wide. The evidence supports imported expansion and an independent human-rating source before any proposal changes weights, thresholds, clue bands, budgets, or fallback behavior.
